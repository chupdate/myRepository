        ...
        while True:
            ...
            for jyyc in result['jyyclist']:
                ...
                if cdate<startdate:
                    ...
                    if cdate<=enddate:
                        entdict=dict(Name=jyyc.get('_name'),regID=jyyc.get('_regCode'),Date=cdate,ID=jyyc['_pripid'],entType=jyyc['_entType'])
